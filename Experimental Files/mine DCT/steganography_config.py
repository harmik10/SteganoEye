...
# Centralized config import for image paths
from config import COVER_IMAGE_FILEPATH, STEGO_IMAGE_FILEPATH
#================================#
...
if raw_cover_image is None:
    print(f"❌ Error: Cover image not found at path: {COVER_IMAGE_FILEPATH}")
